...
interface ApiService {
    ...
    @GET("/{v}/{user.id}/user/deal/{type}/{deal.id}/ticket/")
    void getDealTickets(@Path("v") String apiVersion, @Path("user.id") String userId, @Path("type") String dealType,
                              @Path("deal.id") String id, @Query("token") String token, @Body Serializable params, RestCallback callback);
    ...
    //Deal api methods
    //-------------------------------------------------------------------
    @GET("/{v}/{user.id}/deal/{type}/")
    void getDeals(@Path("v") String apiVersion, @Path("user.id") String userId, @Path("type") String dealType,
                  @Query("token") String token, @Body Serializable params, RestCallback callback);

    @GET("/{v}/{user.id}/deal/{type}/{deal.id}/")
    void getDealInfo(@Path("v") String apiVersion, @Path("user.id") String userId, @Path("type") String dealType,
                     @Path("deal.id") String dealId, @Query("token") String token, RestCallback callback);

    @GET("/{v}/{user.id}/deal/{type}/{deal.id}/venue/")
    void getDealVenues(@Path("v") String apiVersion, @Path("user.id") String userId, @Path("type") String dealType,
                       @Path("deal.id") String dealId, @Query("token") String token, @Body Serializable params, RestCallback callback);

    @POST("/{v}/{user.id}/deal/{type}/{deal.id}/checkout/")
    void dealCheckout(@Path("v") String apiVersion, @Path("user.id") String userId, @Path("type") String dealType,
                      @Path("deal.id") String dealId, @Query("token") String token, @Body Serializable params, RestCallback callback);
}
